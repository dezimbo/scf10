...
export default function ClientAdd({ updateOnClose, getCurrData, printOpen, getLastOrder }) {
    ...
    async function onSubmit(data) {
        ...
        try {
            await axios.post('https://scf10.herokuapp.com/api/order/add', { ...data },
                {
                    headers: {
    ...
    const { fields, append, remove } = useFieldArray({ control, name: 'fieldsArr', });
    ...
    React.useEffect(() => {
        ...
        if (newVal > oldVal) {
            for (let i = oldVal; i < newVal; i++) {
                append({ model: '', fract: '', appearance: '', equipment: '', fio: '', phone: '' });
            ...
            <React.Fragment key={i}>
                ...
                <Grid item xs={10} md={3} lg={3} >
                    ...
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <Checkbox sx={{ mt: 1 }} onChange={(e) => { field.onChange(e.target.checked) }} icon={<Viber />} checkedIcon={<Viber sx={{ color: purple[400] }} />} />
                    ...
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <Checkbox sx={{ mt: 1 }} onChange={(e) => { field.onChange(e.target.checked) }} icon={<Telegram />} checkedIcon={<Telegram sx={{ color: blue[500] }} />} />
                    ...
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <Checkbox sx={{ mt: 1 }} onChange={(e) => { field.onChange(e.target.checked) }} icon={<WhatsAppIcon />} checkedIcon={<WhatsAppIcon sx={{ color: green['A400'] }} />} />
