      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          <AppBar
            ...
            color={hasReady ? 'success' : 'secondary'}
          >
            <Toolbar
              variant='dense'
              sx={{
              ...
              >
                ...
                <Grid item xs={4} md={3} lg={3} sx={{}}>
                  <Typography
                    ...
                    gutterBottom
                    component='div'
                    sx={{ textAlign: 'right', color: hasReady && teal[500] }}
                  >
                    {hasReady ? 'Готов:' : 'Не готов'}
                    <Switch
                      color='success'
                      {...register(`fieldsArr.0.hasReady`)}
                      defaultChecked={printRow.hasReady}
                    />
                  </Typography>
                </Grid>
                {hasReady && (
