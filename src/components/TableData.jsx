...
import { Paper, Stack, TextField, IconButton, Box, CircularProgress, } from '@mui/material';
...
function CustomToolbar() {
    ...
    return (
        <GridToolbarContainer>
            <Button sx={{ display: { xs: 'none', sm: 'flex' } }} startIcon={<ReplayIcon />} size="small" onClick={updateOnClose} >обновить</Button>
            <GridToolbarColumnsButton sx={{ display: { xs: 'none', sm: 'flex' } }} />
            <GridToolbarDensitySelector sx={{ display: { xs: 'none', sm: 'flex' } }} />
        </GridToolbarContainer>
    );
}
...
function QuickSearchToolbar(props) {
    ...
    return (
        <Stack direction="row" spacing={2} justifyContent="space-between" sx={{ p: '1rem' }}>
...
export default function TableData() {
    ...
    React.useEffect(() => { setRows(dataRows) }, [dataRows]);
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                ...
                return (
                    <>
                        <IconButton onClick={(e) => onClick(e, 'print')} size="large" color="primary" >
                            <LocalPrintshopIcon />
                        </IconButton>
